...
<html>
	...
	<body>
		...
		<div class="head_b">
			<div class="head_b_a">
				<h2>贝睿性格测试</h2>
				<p>这是一份来自专业金融职前培训机构-贝睿的一份基于性格色彩学的测评，它将有助于测试者深入了解自己的深层次性格，从而帮助自己得到更好的职业定位。</p>
			</div>
		</div>
		<div class="comment">
			<ul style="padding: 0px 0px 0px 0px; margin-left: 40px;">
				<li>
						...
						<div class="answer">
							<input type="radio" id="item_1_1" name="item_1" checked>
					...
					<li>
						...
						<div class="answer">
							<input type="radio" id="item_2_1" name="item_2" checked>
					...
					<li>
						...
						<div class="answer">
							<input type="radio" id="item_3_1" name="item_3" checked>
					...
					<li>
						...
						<div class="answer">
							<input type="radio" id="item_4_1" name="item_4" checked>
					...
					<li>
						...
						<div class="answer">
							<input type="radio" id="item_5_1" name="item_5" checked>
					...
					<li>
						...
						<div class="answer">
							<input type="radio" id="item_6_1" name="item_6" checked>
					...
					<li>
						...
						<div class="answer">
							<input type="radio" id="item_7_1" name="item_7" checked>
					...
					<li>
						...
						<div class="answer">
							<input type="radio" id="item_8_1" name="item_8" checked>
					...
					<li>
						...
						<div class="answer">
							<input type="radio" id="item_9_1" name="item_9" checked>
					...
					<li>
						...
						<div class="answer">
							<input type="radio" id="item_10_1" name="item_10" checked>
					...
					<li>
						...
						<div class="answer">
							<input type="radio" id="item_11_1" name="item_11" checked>
					...
					<li>
						...
						<div class="answer">
							<input type="radio" id="item_12_1" name="item_12" checked>
					...
					<li>
						...
						<div class="answer">
							<input type="radio" id="item_13_1" name="item_13" checked>
					...
					<li>
						...
						<div class="answer">
							<input type="radio" id="item_14_1" name="item_14" checked>
					...
					<li>
						...
						<div class="answer">
							<input type="radio" id="item_15_1" name="item_15" checked>
					...
					<li>
						...
						<div class="answer">
							<input type="radio" id="item_16_1" name="item_16" checked>
					...
					<li>
						...
						<div class="answer">
							<input type="radio" id="item_17_1" name="item_17" checked>
					...
					<li>
						...
						<div class="answer">
							<input type="radio" id="item_18_1" name="item_18" checked>
					...
					<li>
						...
						<div class="answer">
							<input type="radio" id="item_19_1" name="item_19" checked>
					...
					<li>
						...
						<div class="answer">
							<input type="radio" id="item_20_1" name="item_20" checked>
					...
					<li>
						...
						<div class="answer">
							<input type="radio" id="item_21_1" name="item_21" checked>
					...
					<li>
						...
						<div class="answer">
							<input type="radio" id="item_22_1" name="item_22" checked>
					...
					<li>
						...
						<div class="answer">
							<input type="radio" id="item_23_1" name="item_23" checked>
					...
					<li>
						...
						<div class="answer">
							<input type="radio" id="item_24_1" name="item_24" checked>
					...
					<li>
						...
						<div class="answer">
							<input type="radio" id="item_25_1" name="item_25" checked>
					...
					<li>
						...
						<div class="answer">
							<input type="radio" id="item_26_1" name="item_26" checked>
					...
					<li>
						...
						<div class="answer">
							<input type="radio" id="item_27_1" name="item_27" checked>
					...
					<li>
						...
						<div class="answer">
							<input type="radio" id="item_28_1" name="item_28" checked>
					...
					<li>
						...
						<div class="answer">
							<input type="radio" id="item_29_1" name="item_29" checked>
					...
					<li>
						...
						<div class="answer">
							<input type="radio" id="item_30_1" name="item_30" checked>
			...
			<div style="text-align:center;margin:10px;">
				<button class="sub" style="width:75px;margin-top:15px;background-color:#6d9c01;color:#fff;border:1px solid #6d9c01;border-radius:3px;">提交</button>
			</div>
			...
			$(".sub").on("click",function(){
				...
				options.each(function(){
					if($(this).prop('checked')){
						...
						data.selectorContent = $(this).parent().find('label').html();
						datas.push(data);
					}
				});
