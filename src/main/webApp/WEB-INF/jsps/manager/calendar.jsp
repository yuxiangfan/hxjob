            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class='params'>
                            报名编码：<input type='text' name='applyCode'/>
                            主题：<input type='text' name='title'/>
                            选择机构：<select name="examCalendarCode" style="width: 200px">
                            <option value=''>全部</option>
                            <c:forEach var="org" items="${organizations}">
                                <option value="${org.fullname}">${org.fullname}</option>
                            </c:forEach>
                        </select>
                            &nbsp;&nbsp;&nbsp
                            考试状态：<select name="examStatus">
                            <option value=''>全部</option>
                        ...
                        <div class="panel-heading">
                            <a href="JavaScript:void(0)" class="btn btn-default btn-flat" onclick="window.location.href='calendar/addExam'">新增考试日历</a>
                        </div>
    ...
    <div class='account' style='display:none'>
        <div>
            ...
            <div class='unit'>
                ...
                <div class='right'><input type='text' id='username' maxLength=16/></div>
            </div>
            <div class='unit'>
                <div class='left'>密码</div>
                <div class='right'><input type='password' id='password' maxLength=16/></div>
            </div>
            <div class='unit'>
                <div class='left'>真实姓名</div>
                <div class='right'><input type='text' id='realname' maxLength=16/></div>
            </div>
            <div class='unit'>
                <div class='left'>联系方式</div>
                <div class='right'><input type='text' id='mobile' maxLength=16/></div>
            </div>
            <div class='unit'>
...
<script src="resources/business-js/manager/calendar.js"></script>
