...
<html>
  ...
  <body class="skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <div class="main-sidebar">
        ...
        <ul class="sidebar-menu">
        	<c:set var="munu" value="GYZL"/>
        	<c:set var="munuc" value="HYGL"/>
            ...
            <div class="col-md-12">
              <div class="panel panel-default">
               ...
               <div class="panel-heading">
                  <a href="JavaScript:void(0)" class="btn btn-default btn-flat" onclick='add()' >新增行业</a>
                </div>
     ...
     <div class='account' style='display:none'>
    	<div>
    		...
    		<div class='unit'>
    			<div class='left'>排序号</div><div class='right'><input type='text' id='sort' maxLength=8 /></div>
    		</div>
    	</div>
    ...
    <script src="resources/business-js/manager/industry.js"></script>
