...
<html>
  ...
  <body class="skin-blue sidebar-mini">
            ...
            <div class="col-md-12">
              <div class="panel panel-default">
               ...
               <div class="panel-heading">
                  <a href="JavaScript:void(0)" class="btn btn-default btn-flat" onclick="window.location.href='selector/new'" >新增精选</a>
                </div>
    ...
    <script src="resources/business-js/manager/article-curriculum.js"></script>
