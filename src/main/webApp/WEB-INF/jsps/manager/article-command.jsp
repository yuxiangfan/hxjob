            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class='params'>&nbsp;&nbsp;&nbsp;&nbsp;
                            所属：<input type='text' name='title'/>
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            性质：<input type='text' name='nature'/>
                            &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class='account' style='display:none'>
        <div>
            ...
            <div class='unit'>
                ...
                <div class='right'><input type='text' id='title' maxLength=16/></div>
            </div>
            <div class='unit'>
                <div class='left'>性质</div>
                <div class='right'><input type='text' id='nature' maxLength=16/></div>
            </div>
            <div class='unit'>
                <div class='left'>简介</div>
                <div class='right'><input type='text' id='brief' maxLength=200/>
                </div>
            </div>
            <div class='unit'>
                <div class='left'>发布时间</div>
                <div class='right'><input type='text' id='publishtime' maxLength=16/>
