            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class='params'>
                            岗位名称：<input type='text' name='title'/>
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            所属机构：<select name='orgcode'>
                            <option value=''>全部</option>
                            <c:forEach var='organization' items='${organizations}'>
                                <option value='${organization.code}'>${organization.shortname}</option>
                            </c:forEach>
                        </select>
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            类别：<select name='type'>
                        ...
                        <div class="panel-heading">
                            <a style="float: left" href="position/newPosition" class="btn btn-default btn-flat">新增岗位</a>
                            <%--报表导入数据--%>
                            <div style="margin-left: 109px;height: 33px" class="report_form ">
                                <ul>
                                    <li><input id="file" type="file" name="file" style="margin-bottom: -2px;float:left;width:180px;"/>
                                        <button class='bt' onclick='submitExcel()'>提交报表</button>
                                    </li>
                                </ul>
                            </div>
                        </div>
...
<script src="resources/business-js/manager/position.js"></script>
<script src="resources/business-js/common.js"></script>
<script>
    var fileExcel = null;
    $(function () {
        $("#file").on('change', function () {
            fileExcel = document.getElementById("file").files[0];
        })
    })
</script>
</body>
