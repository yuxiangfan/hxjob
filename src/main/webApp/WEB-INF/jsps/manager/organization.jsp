                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading">
                            <a style="float: left" href="org/newOrg" class="btn btn-default btn-flat">新增机构</a>
                            <%--报表导入数据--%>
                            <%--报表导入数据--%>
                            <div style="margin-left: 109px;height: 33px" class="report_form ">
                                <ul>
                                    <li><input id="file" type="file" name="file" style="margin-bottom: -2px;float:left;width:180px;"/>
                                        <button class='bt' onclick='submitOrgExcel()'>提交报表</button>
                                    </li>
                                </ul>
                            </div>
                        </div>
...
<script src="resources/business-js/manager/organization.js"></script>
