...
exports.unitsDesc = ['year', 'month', 'week', 'day.jsp', 'hour', 'minute', 'second', 'millisecond']; // descending
...
var largeTokenMap = {
    ...
    W: { value: 3, unit: 'week' },
    w: { value: 3, unit: 'week' },
    D: { value: 4, unit: 'day.jsp' },
    d: { value: 4, unit: 'day.jsp' } // day of week
};
...
var Calendar = /** @class */ (function () {
    ...
    Calendar.prototype.zoomTo = function (newDate, viewType) {
        var spec;
        viewType = viewType || 'day.jsp'; // day is default zoom
...
var ListView = /** @class */ (function (_super) {
    ...
    ListView.prototype.renderDates = function (dateProfile) {
        ...
        while (dayStart < viewEnd) {
            ...
            dayRanges.push(new UnzonedRange_1.default(dayStart, dayStart.clone().add(1, 'day.jsp')));
            dayStart.add(1, 'day.jsp');
        }
        this.dayDates = dayDates;
