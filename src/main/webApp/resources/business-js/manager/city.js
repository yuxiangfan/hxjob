				...
				success:function(data){
					...
					if(data!=null){
						...
						for(var i=0;i<data.rows.length;i++){
							var bt = "<button class='bt' onclick=editCity('"+list[i].id+"') >编辑</button>" +
									"<button class='bt' onclick=deleteCity('"+list[i].id+"') >删除</button>";
